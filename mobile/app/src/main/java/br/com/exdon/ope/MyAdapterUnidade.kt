...
class MyAdapterUnidade(val arrayList: ArrayList<Model>, val context: Context) :
    RecyclerView.Adapter<MyAdapterUnidade.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(context, UnidadesDetailsActivity::class.java)

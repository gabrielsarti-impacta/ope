...
import kotlinx.android.synthetic.main.activity_document_meus_exames.layout_menu_lateral
import kotlinx.android.synthetic.main.activity_meus_exames.*

class DocumentMeusExamesActivity : DebugActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_document_meus_exames)
